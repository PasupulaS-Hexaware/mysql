using dotnetmysl.Api.Installer;
using dotnetmysl.Api.Middleware;
using dotnetmysl.Data.Repositories;
...
using System;
using dotnetmysl.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;
namespace dotnetmysl.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotnetmysl V1");
        });
