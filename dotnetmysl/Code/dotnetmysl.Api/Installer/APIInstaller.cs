...
using dotnetmysl.Api.Filters;
using dotnetmysl.Business.Installer;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
using Microsoft.Extensions.Logging;

namespace dotnetmysl.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetmysl API", Version = version + "-" + branch });
        });
